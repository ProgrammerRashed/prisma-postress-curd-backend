...
export namespace Prisma {
  ...
  */
  ...
  export interface Prisma__BikeClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    services<T extends Bike$servicesArgs<ExtArgs> = {}>(args?: Subset<T, Bike$servicesArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ServicePayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  export type BikeCreateInput = {
    ...
    services?: ServiceCreateNestedManyWithoutBikeInput
  }
  ...
  export type BikeUncheckedCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    services?: ServiceUncheckedCreateNestedManyWithoutBikeInput
  }
  ...
  export type BikeUpdateInput = {
    ...
    services?: ServiceUpdateManyWithoutBikeNestedInput
  }
  ...
  export type BikeUncheckedUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    services?: ServiceUncheckedUpdateManyWithoutBikeNestedInput
  }
